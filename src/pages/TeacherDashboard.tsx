      ...
      <div className="min-h-screen flex w-full bg-[hsl(var(--dashboard-bg))]">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <header className="h-14 flex items-center justify-between border-b border-[hsl(var(--dashboard-border))] bg-[hsl(var(--dashboard-card))] px-5">
            ...
            <div className="flex items-center gap-3">
              <ThemeToggle />
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#e09615] font-mono text-[12px] font-bold text-[hsl(var(--dashboard-bg))]">"flex h-8 w-8 items-center justify-center rounded-full bg-[#e09615] font-mono text-[12px] font-bold text-[hsl(var(--dashboard-bg))]"> className="flex h-8 w-8 items-center justify-center rounded-full bg-[#e09615] font-mono text-[12px] font-bold text-[hsl(var(--dashboard-bg))]"> font-mono text-[12px] font-bold text-[hsl(var(--dashboard-bg))]">
