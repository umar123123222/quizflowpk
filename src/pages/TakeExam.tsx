  ...
  useEffect(() => {
    ...
    const fetchExam = async () => {
      ...
      const { data: examData, error: examError } = await supabase
        .from("exams")
        .select("id, title, description, time_limit, organization_id, created_by, result_visibility, start_time, end_time, shuffle_questions, shuffle_options, passing_percentage")
        .eq("code", code)
