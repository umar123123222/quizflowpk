      ...
      <div className="container mx-auto px-4">
        <div
          ...
          style={{
            ...
            border: isDark ? '1px solid rgba(224,150,21,0.15)' : '1px solid rgba(224,150,21,0.2)',
          }}
        >
          <div className="absolute -top-12 -right-12 h-48 w-48 rounded-full" style={{ backgroundColor: 'rgba(224,150,21,0.05)' }} />
          <div className="absolute -bottom-8 -left-8 h-32 w-32 rounded-full" style={{ backgroundColor: 'rgba(224,150,21,0.05)' }} />
          ...
          <Button
            ...
            style={{ backgroundColor: '#e09615', color: '#ffffff', borderRadius: '8px' }}
          >
            <Link to="/signup">
              Get Started Free
