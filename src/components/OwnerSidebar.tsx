import { FileText, Users, BarChart3, Settings, GraduationCap, LogOut, ClipboardList, Plus } from "lucide-react";
...
const navItems = [
  ...
  { title: "Create Exam", url: "/dashboard/owner/create-exam", icon: FileText },
